...
class LlamaSdpaAttention(LlamaAttention):
    ...
    SDPA API.
    """
    def _attn(self,query, key, value, attn_mask=None, dropout_p=0.0, is_causal=False, scale=None, attention_adapter=None):
    ...
    def forward(
        ...
        # attn_output_original = torch.nn.functional.scaled_dot_product_attention(
        #     query_states,
        #     key_states,
        #     value_states,
